...
class GPTMultiToken(BaseGPT):
    def __init__(
        ...
        shoulder_output_size = (
            self.shoulder_output_dim * self.num_multi_token_output_heads
        )
        c_stick_output_size = (
            self.c_stick_output_dim * self.num_multi_token_output_heads
        )
        main_stick_output_size = (
            self.main_stick_output_dim * self.num_multi_token_output_heads
        )
